  ...
  return (
    <header className="flex flex-col min-h-[100dvh] pb-16 mt-4 sm:mt-12 w-[80%] ">
      ...
      <svg
        ...
        className="block lg:hidden scale-[40%]"
      >
      ...
      <div className="flex lg:flex-row flex-col  gap-8 pb-8">
        <img
          src="https://cpwebassets.codepen.io/assets/packs/illu-editor-24091b7edc92fba11a2595fe767e6c2b.png"
          className="max-w-full lg:w-[40vw] h-max aspect-auto"
          alt="code image"
        />
        <div className="flex flex-col text-white fill-white justify-center items-center text-center lg:text-left lg:order-first">
          <div className="flex flex-row gap-4 antialiased w-full sm:justify-center sm:items-center ">
            <svg
              viewBox="0 0 100 100"
              className="lg:flex hidden mb-[2rem] h-12 basis-[50px]"
            >
