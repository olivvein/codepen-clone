...
export default function HomeNav({}: Props) {
  return (
    <div className="w-screen text-white flex flex-row justify-around items-stretch p-[2%] g-4 overflow-hidden ">
      <a href="/" className="sm:hidden  flex items-center pl-6">
        <svg
          viewBox="0 0 100 100"
          fill="#fff"
          stroke="#fff"
      ...
      <div className="flex items-center mr-4 flex-grow max-w-full mx-auto scale-[70%] sm:scale-100">
        <div className="relative flex items-center w-full h-12 rounded-lg focus-within:shadow-lg gap-2 bg-cp-color-6 focus-within:bg-cp-color-6/80 overflow-hidden">
          ...
          <input
            className="scale-[70%] sm:scale-100 peer h-full w-full outline-none text-md font-semibold  bg-cp-color-6 focus-within:bg-cp-color-6/80  text-cp-color-7 sm:pl-0 pl-2 pr-4"
            type="text"
            id="search"
      ...
      <a
        ...
        href="/login"
        className="scale-[70%] sm:scale-100 bg-cp-color-12 hover:bg-cp-color-13 text-white text-sm p-4 py-2 px-4 rounded mr-2 mb-1 flex flex-col items-center justify-center"
      >
        Log In
      </a>
    </div>
